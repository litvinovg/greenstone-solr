 ...
 * @since solr 1.3
 */
public class NewSolrHighlighter extends SolrHighlighter implements PluginInfoInitialized
{

  public static Logger log = LoggerFactory.getLogger(NewSolrHighlighter.class);
  
  private SolrCore solrCore;

  public NewSolrHighlighter() {
  }

  public NewSolrHighlighter(SolrCore solrCore) {
